...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <input type="submit" value="Xác nhận" name="update_now" class="inline-btn">
      </div>
   </form>
</section>
<?php
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">Xem</a>
         <?php
   ...
   <?php
         ...
         echo '<p class="empty">Chưa có video được thêm nào!</p>';
      }
   ?>
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="Bình luận..." maxlength="1000" cols="30" rows="10"></textarea>
