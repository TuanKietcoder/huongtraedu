...
<section class="teachers">
   ...
   <h1 class="heading">Nhà Sáng Tạo</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="tutor_profile.php" method="post">
            ...
            <input type="submit" value="Hồ sơ" name="tutor_fetch" class="inline-btn">
         </form>
      </div>
      <?php
            }
         }else{
            echo '<p class="empty">Chưa có nhà sáng tạo nào!</p>';
         }
      ?>
