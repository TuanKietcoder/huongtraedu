...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         ...
         <option value="deacitve">Không công khai</option>
      </select>
      ...
      <input type="submit" value="Chỉnh sửa" name="update" class="btn">
      <div class="flex-btn">
   ...
   <?php
         ...
         echo '<p class="empty">Chưa tìm thấy video nào! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Thêm</a></p>';
      }
   ?>
