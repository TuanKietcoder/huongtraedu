...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Thêm Nội Dung</h3>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Xóa" class="delete-btn" onclick="return confirm('Bạn chắc chắn muốn xóa?');" name="delete_video">
         </form>
