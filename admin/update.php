...
if(isset($_POST['submit'])){
   ...
   if(!empty($profession)){
      ...
      $message[] = 'Nghề nghiệp được cập nhật thành công!';
   }
...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            <p>Mật khẩu cũ </p>
            <input type="password" name="old_pass" placeholder="Mật khẩu cũ" maxlength="20"  class="box">
            <p>Mật khẩu mới </p>
            <input type="password" name="new_pass" placeholder="Mật khẩu mới" maxlength="20"  class="box">
            <p>Xác nhận lại mật khẩu </p>
            <input type="password" name="cpass" placeholder="Xác nhận lại mật khẩu" maxlength="20"  class="box">
         </div>
      </div>
      <p>Ảnh</p>
      <input type="file" name="image" accept="image/*"  class="box">
      <input type="submit" name="submit" value="Chỉnh sửa" class="btn">
   </form>
