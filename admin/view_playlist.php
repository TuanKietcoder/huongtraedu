   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Chỉnh sửa</a>
            <input type="submit" value="Xóa" class="delete-btn" onclick="return confirm('Bạn chắc chắn muốn xóa danh sách phát?');" name="delete">
         </form>
      </div>
   </div>
   <?php
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_content.php?get_id=<?= $video_id; ?>" class="option-btn">Chỉnh sửa</a>
            <input type="submit" value="Xóa" class="delete-btn" onclick="return confirm('Bạn chắc chắn muốn xóa video?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">Chưa có video nào! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Thêm video</a></p>';
      }
   ?>
