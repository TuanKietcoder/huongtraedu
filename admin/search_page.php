...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('Bạn chắc chắn muốn xóa?');" name="delete_video">
         </form>
   ...
   <?php
      ...
      echo '<p class="empty">Vui lòng nhập nội dung cần tìm vào ô tìm kiếm</p>';
   }
   ?>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete_playlist" class="delete-btn" onclick="return confirm('Bạn chắc chắn muốn xóa?');" name="delete">
         </form>
