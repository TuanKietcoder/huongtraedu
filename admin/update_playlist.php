...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Tiêu đề" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>Mô tả <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Mô tả" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
